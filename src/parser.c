...
enum {
  ...
  sym_array_type = 52,
  sym_pair_type = 53,
  sym_pair_elem_type = 54,
  sym_raw_pair_type = 55,
  sym_expr = 56,
  sym_array_liter = 57,
  sym_array_elem = 58,
  sym_array_indexes = 59,
  sym_lvalue = 60,
  sym_rvalue = 61,
  sym_newpair = 62,
  sym_call = 63,
  sym_pair_elem = 64,
  sym_pair_elem_selector = 65,
  sym_arg_list = 66,
  sym_stats = 67,
  sym_stat = 68,
  sym_decl_stat = 69,
  ...
  aux_sym_array_liter_repeat1 = 72,
  aux_sym_array_indexes_repeat1 = 73,
  aux_sym_stats_repeat1 = 74,
};
