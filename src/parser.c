...
enum {
  ...
  sym_array_type = 50,
  sym_pair_type = 51,
  sym_pair_elem_type = 52,
  sym_raw_pair_type = 53,
  sym_expr = 54,
  sym_stats = 55,
  sym_stat = 56,
  sym_decl_stat = 57,
  ...
  switch (state) {
    ...
    case 5:
      ...
      if ((0 <= lookahead && lookahead <= '\t') ||
          (11 <= lookahead && lookahead <= '!') ||
          ('#' <= lookahead && lookahead <= '&') ||
          ('(' <= lookahead && lookahead <= 127)) ADVANCE(4);
      END_STATE();
    case 6:
    ...
    case 44:
      ...
      END_STATE();
    case 45:
      if (sym_str_liter_character_set_1(lookahead)) ADVANCE(4);
      END_STATE();
    case 46:
